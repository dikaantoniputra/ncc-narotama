...
<section class="bg-[#F7F7F7]">
    ...
    <section class="tab-content hidden" id="tab-1">
        <div class="lg:my-[60px] my-[30px] lg:mx-[80px] mx-[40px] bg-white grid lg:grid-cols-4 grid-cols-1 items-center rounded-[18px] justify-between p-[12px] gap-[24px]">
            <div class="bg-[#F7F7F7] flex items-center px-[24px] rounded-[6px]">
                <input class="w-full border-none focus:border-none focus:outline-none focus:ring-0 bg-[#F7F7F7]" placeholder="Cari Posisi" type="text">
            ...
            <div class="bg-[#F7F7F7] flex items-center px-[24px] rounded-[6px]">
                <input class="w-full border-none focus:border-none focus:outline-none focus:ring-0 bg-[#F7F7F7]" placeholder="Cari Kota" type="text">
                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="grid lg:grid-cols-2 grid-cols-1 gap-[28px]">
                ...
                <div class="shadow-xl">
                    <div class="bg-[#F7F7F7] p-[20px] flex flex-wrap gap-[24px] rounded-tl-[8px] rounded-tr-[8px]">
                        ...
                        <div>
                            <div class="bg-[#DC3545] px-[12px] py-[4px] rounded-[20px] text-[12px] text-white font-bold">Tidak Sesuai</div>
                        </div>
                    </div>
                </div>
            </div>
