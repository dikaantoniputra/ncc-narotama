        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                @if (Auth::user()->role == 'admin')
                    <div class="btn-group">
                        <a href="{{ url('admin/pelatihans') }}" class="btn btn-primary">Tambah Pelatihan</a>
                        ...
                        <tbody>
                            @forelse ($datalowongan as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->kota }}</td>
                                    <td>{{ $item->lamaran->count() }}</td>
                                    <td class="flex gap-[10px]">
                                        <a href="{{ route('lamaran.show', $item->id) }}" class="text-white px-[10px] py-[5px] bg-green-500 rounded-lg">Lihat</a>
                                    </td>
                                </tr>
                            @empty
                                <div>
